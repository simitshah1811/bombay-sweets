...
ADD COLUMN     "promotionDiscountValue" DECIMAL(10,2);

-- AlterTable
ALTER TABLE "Restaurant" ADD COLUMN     "timezone" TEXT NOT NULL DEFAULT 'America/Los_Angeles';
...
CREATE TABLE "Promotion" (
    ...
    "isDemoPromotion" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE INDEX "PromotionRedemption_customerEmail_idx" ON "PromotionRedemption"("customerEmail");
